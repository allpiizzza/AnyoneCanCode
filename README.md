...
<div class="ide">                       <!-- grid: 타이틀 / 본체 / 패널 / 상태바 -->
  ...
  <div class="workbench">                <!-- grid: 48px / 246px / 1fr -->
    ...
    <div class="editor">
      <div class="tabbar"></div>         <!-- 문서 9개가 탭으로 -->
...
문서 목록은 파일 맨 위 **`FILES` 배열이 유일한 출처**입니다. 여기만 고치면 탭·탐색기·명령 팔레트·상태바 "문서 n/9"이 한꺼번에 따라옵니다.
...
- **공개 전** — 잠긴 문서는 본문이 잠금 화면으로 교체되고, 탭·탐색기·팔레트에 자물쇠(`.lk`)가 붙습니다. 상태바에 `🔒 D-n`, 터미널 패널에는 `permission denied` 줄이 나옵니다
